  ...
  return (
    <View style={styles.main}>
      <ScrollView>
        ...
        <Text style={styles.blocktext}>Popular Movies</Text>
        ...
        <Text style={[styles.blocktext, { marginTop: 15 }]}>Tv Shows</Text>
        <FlatList
          horizontal={true}
          data={Shows}
          keyExtractor={(item) => item.id}
        ...
        <Text style={[styles.blocktext, { marginTop: 15 }]}>Coming soon..</Text>
